...
### Крок 8. Виконання Use Case пошуків (SPL-запити)
Усі пошуки виконувались з однаковим часовим діапазоном: 03/01/2023 12:00:00.000 PM — 03/02/2023 12:00:00.000 PM.

1.Пошук невдалих спроб входу на хості mailsv.
![Splunk](splunk11.jpg)

2.Пошук невдалих спроб входу на хості www1.
![Splunk](splunk12.jpg)

3.Пошук невдалих спроб входу на хості www2.
![Splunk](splunk13.jpg)

4.Пошук HTTP-відповідей зі статусом «Client side error» (4xx) по всіх джерелах.
![Splunk](splunk14.jpg)

5.Пошук HTTP-відповідей зі статусом «Client side error» (4xx) на хості www1.
![Splunk](splunk15.jpg)

6.Пошук HTTP-відповідей зі статусом «Client side error» (4xx) на хості www3.
![Splunk](splunk16.jpg)

7.Пошук HTTP-відповідей зі статусом «Server-side error» (5xx) по всіх джерелах.
![Splunk](splunk17.jpg)

8.Пошук HTTP-відповідей зі статусом «Server-side error» (5xx) на хості www2.
![Splunk](splunk18.jpg)

9.Пошук HTTP-відповідей зі статусом «Server-side error» (5xx) на хості www3.
![Splunk](splunk19.jpg)

10.Пошук успішних (accepted) спроб входу по SSH по всіх джерелах.
![Splunk](splunk20.jpg)

11.Пошук невдалих (failed) спроб входу по SSH по всіх джерелах.
![Splunk](splunk21.jpg)

12.Пошук невдалих (failed) спроб входу по SSH на хості www2.
![Splunk](splunk22.jpg)

13.Пошук успішних (accepted) спроб входу по SSH на хості www3.
![Splunk](splunk23.jpg)

14.Пошук успішних (accepted) спроб входу по SSH на хості mailsv.
![Splunk](splunk24.jpg)

У ході виконання практичного завдання було створено обліковий запис Splunk Cloud, активовано пробний період, завантажено тестовий набір даних (логи мейл-сервера, веб-серверів та відділу продажів), проведено первинну індексацію та аналіз даних, а також виконано серію пошукових запитів мовою SPL для виявлення невдалих спроб SSH-автентифікації та HTTP-помилок клієнтської й серверної сторони.
